...
class Bot(BotBase):
    ...
    async def on_command_error(self, ctx, exc):
        if isinstance(exc, CommandNotFound):
            # pass
            await ctx.send(f"{choice(('Такой команды нет долбоёб', 'Ебать это чё за поеботина', 'Если ты такой тупой команд не знаешь пиши >help', 'Ты заебал', 'Пошёл нахуй', 'Ебать бро лечись', 'Учи команды мудоёбина, пиши >help или иди нахуй', 'БЛЯЯТЬ ДОСТАЛ'))}")
